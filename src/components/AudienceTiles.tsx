  ...
  return (
    <section ref={sectionRef} className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Parallax-grid (nedtonad på mobil) */}
        <div
        ...
        {/* Svaga spotlight-radialer (nedtonade på mobil) */}
        <div
          className="absolute inset-0 opacity-0 sm:opacity-100"
          style={{
            background: 'radial-gradient(600px 280px at 20% 10%, rgba(255,255,255,0.06), transparent 60%)',
        ...
        <div
          className="absolute inset-0 opacity-0 sm:opacity-100"
          style={{
            background: 'radial-gradient(800px 360px at 85% 90%, rgba(255,255,255,0.05), transparent 70%)',
            animation: 'drift 80s linear infinite',
          }}
        />

        {/* Flytande glows (av på mobil) */}
        <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
          {audiences.map((audience, index) => (
            ...
            >
              ...
              >
                {/* Header gradient area – kortare på mobil */}
                <div
                  className={`
