  ...
  return (
    <>
      <style>{`
        ...
        @keyframes slow-move-reverse {
          0%,100% { transform: translate(0,0) scale(1); }
          50% { transform: translate(-10px,-6px) scale(1.012); }
        }
        @keyframes pulse {
          0%,100% { opacity: 0.1; }
          50% { opacity: 0.25; }
        ...
        .animate-slow-move {
          animation: slow-move 25s ease-in-out infinite;
        }
        .animate-slow-move-reverse {
          animation: slow-move-reverse 28s ease-in-out infinite;
        }
      `}</style>
      ...
      >
        {/* Bakgrund - uppgraderad */}
        <div className="absolute inset-0 overflow-hidden">
          {/* Basgradient med djup */}
          <div
            className="absolute inset-0"
            style={{
              background:
                'radial-gradient(circle at 25% 35%, #0f1f44 0%, #1b2a6a 45%, #0f1f44 90%)',
            }}
          />

          {/* Svävande glows */}
          <div
            className="absolute w-[900px] h-[900px] rounded-full blur-3xl opacity-20 -left-64 -top-64 animate-slow-move"
            style={{
              background: 'radial-gradient(circle, rgba(99,102,241,0.25) 0%, transparent 70%)',
            }}
          />
          <div
            className="absolute w-[700px] h-[700px] rounded-full blur-3xl opacity-15 right-1/4 bottom-20 animate-slow-move-reverse"
            style={{
          ...
          <div
            ...
            aria-hidden="true"
            style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height='100' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='f'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='2' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%' height='100%' filter='url(%23f)' opacity='0.04'/%3E%3C/svg%3E")`,
          ...
          {Array.from({ length: 35 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                animation: `pulse ${4 + Math.random() * 4}s ease-in-out ${Math.random() * 2}s infinite`,
              }}
            />
          ))}
        </div>
