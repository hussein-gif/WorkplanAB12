...
const WhyChooseCandidatesSection: React.FC<WhyChooseCandidatesSectionProps> = ({
  ...
  return (
    <section
      className="relative py-14 md:py-24 px-6 md:px-8 bg-white overflow-hidden -mt-[2px] md:mt-0 scroll-mt-24"
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                <div
                  aria-hidden="true"
                  className="card-pattern absolute inset-0 pointer-events-none rounded-xl md:rounded-2xl"
                />
                <span aria-hidden="true" className="card-accent" />
                ...
                >
                  ...
                  <span aria-hidden="true" className="icon-ring" />
                </div>
                ...
                <span aria-hidden="true" className="hidden md:block card-bottom-bar" />
              </div>
            );
          })}
        </div>
