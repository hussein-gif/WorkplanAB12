...
const CandidateFormSection: React.FC<CandidateFormSectionProps> = React.memo(
  ({ candidateForm, handleCandidateSubmit, handleCandidateChange, loading = false }) => {
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0" aria-hidden="true">
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse at center, #A7F3D0, transparent 60%)",
            }}
          />
          <div
