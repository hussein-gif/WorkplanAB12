...
const WhyChooseUsSection: React.FC<WhyChooseUsSectionProps> = ({
  ...
  const features = [
    {
      ...
      backgroundImage:
        "https://i.ibb.co/hJykWM0G/IMAGE-2025-08-07-19-36-02.jpg",
    },
    {
      ...
      backgroundImage:
        "https://i.ibb.co/wrwTrGJ9/IMAGE-2025-08-07-19-42-10.jpg",
    },
    {
      ...
      backgroundImage:
        "https://i.ibb.co/Qjvp4Fvq/IMAGE-2025-08-07-19-41-36.jpg",
    },
    {
      ...
      backgroundImage:
        "https://i.ibb.co/KcgmytRM/IMAGE-2025-08-07-19-40-50.jpg",
    },
  ];
  ...
  return (
    <section
      className="py-16 px-6 md:py-24 md:px-8 relative overflow-hidden"
      style={{
        contentVisibility: "auto",
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          >
            Fyra löften som gör bemanning enkel, träffsäker och trygg – från
            första kontakt till avslutat uppdrag.
          </p>
        </div>
        ...
        <div className="md:hidden -mx-6 relative">
          <div
            ref={sliderRef}
            className="flex gap-4 px-1 no-scrollbar overflow-x-auto snap-x snap-mandatory pb-2"
            style={{
          ...
          <div
            className={`absolute inset-y-0 left-0 w-14 pointer-events-none transition-opacity duration-200 ${
          ...
          >
            ...
            <button
              ...
              className={`absolute left-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/45 text-white backdrop-blur-md ring-1 ring-white/20 shadow-md pointer-events-auto transition ${
                canLeft ? "opacity-100" : "opacity-0"
              }`}
            >
              <ChevronLeft size={18} />
          ...
          {/* Höger gradient + pil */}
          <div
            className={`absolute inset-y-0 right-0 w-14 pointer-events-none transition-opacity duration-200 ${
          ...
          >
            ...
            <button
              ...
              onClick={() => scrollByCard(1)}
              className={`absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/45 text-white backdrop-blur-md ring-1 ring-white/20 shadow-md pointer-events-auto transition ${
                canRight ? "opacity-100" : "opacity-0"
              }`}
            >
