  ...
  return (
    <div className="relative" onKeyDown={handleKeyDown}>
      <button
        ...
        aria-expanded={open}
        onClick={() => setOpen((o) => !o)}
        className="w-full px-4 py-2.5 md:py-3 text-[16px] bg-white/10 border border-white/20 rounded-xl text-white focus:bg-white/15 focus:border-white/40 focus:outline-none transition-all duration-300 flex items-center justify-between"
      >
            ...
            return (
              <li key={opt.value}>
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-[16px] flex items-center justify-between transition-colors select-none ${
                    isSelected
...
const ContactFormSection: React.FC<ContactFormSectionProps> = ({
  ...
  return (
    <section id="kontakt-form" className="contact-form-section relative">
      {/* Wave – kortare på mobil */}
      <div
        className="absolute top-0 left-0 w-full h-12 md:h-20 overflow-hidden pointer-events-none"
        style={{ zIndex: 0 }}
      >
        <svg
      ...
      <div className="relative z-10 max-w-4xl mx-auto py-14 md:py-24 px-6 md:px-8">
        <h2
          className="text-3xl sm:text-4xl md:text-5xl text-white font-medium text-center mb-6 md:mb-8"
          style={{ fontFamily: 'Zen Kaku Gothic Antique, sans-serif' }}
        >
          Börja Bemanna
        </h2>

        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-lg">
          <form onSubmit={handleFormSubmit} className="space-y-5 md:space-y-6">
            {/* Rad 1 */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div>
                <label className="block text-white/80 text-sm font-medium mb-1.5 md:mb-2">
                  Förnamn *
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-2.5 md:py-3 text-[16px] bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:bg-white/15 focus:border-white/40 focus:outline-none transition-all"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2.5 md:py-3 text-[16px] bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:bg-white/15 focus:border-white/40 focus:outline-none transition-all"
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <MessageSquare className="absolute left-4 top-3.5 text-white/40" size={18} />
                  <textarea
                    name="meddelande"
                    ...
                    required
                    rows={4}
                    className="w-full pl-12 pr-4 py-2.5 md:py-3 text-[16px] bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:bg-white/15 focus:border-white/40 focus:outline-none transition-all resize-none"
            ...
            <div className="pt-2 md:pt-4 space-y-4">
              <button
                type="submit"
                className="btn-min group inline-flex w-full md:w-auto items-center justify-center gap-2 px-6 py-3 rounded-xl text-white text-base tracking-wide transition-all duration-200"
              >
              ...
              <label className="flex items-start gap-3">
                ...
                />
                <span className="text-white/70 text-xs md:text-sm leading-relaxed">
                  Jag godkänner att Workplan lagrar och behandlar mina uppgifter
                  för att kunna återkomma med information om bemanningslösningar.
                </span>
              </label>
            </div>
          </form>
