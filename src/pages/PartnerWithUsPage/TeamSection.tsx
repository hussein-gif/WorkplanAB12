    ...
    <section className="team-section">
      ...
      <style>{`        
        ...
        .team-section::before {
          ...
          width: 100%;
          height: 200px;
          background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='600' viewBox='0 0 800 600'><g fill='none' stroke='rgba(255,255,255,0.1)' stroke-width='2'><path d='M0 200 Q200 100 400 200 T800 200' /></g></svg>");
