    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          ...
          srcSet="
            https://i.ibb.co/GmGLTKd/77947250096.png 1280w
          "
        />
        {/* Mörkare overlay på mobil, oförändrad på md+ */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-8 text-center pt-6 md:pt-0">
        ...
        <p
          className={`
            ...
            ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-3 opacity-0 md:translate-y-4'}
          `}
        ...
        {/* Primary CTA - mobil lite bredare/tap-friendly, desktop oförändrad */}
        <button
          onClick={() => {
