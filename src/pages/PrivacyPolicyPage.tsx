 ...
 * - Bakgrund #F7FAFF
 * - Vänster sticky sidomeny (TOC) med robust scroll-spy (utan IO-buggar)
 * - Aktiv punkt i TOC: bakgrund #08132B och vit text
 * - Samma typografi (Zen Kaku + Inter) och kort/ren hero
 */
...
const NAV_OFFSET_PX = 120; // samma offset som TOS (justera om din navbar ändras)
              ...
              <ul className="space-y-1" style={{ fontFamily: 'Inter, sans-serif' }}>
                {sections.map((s) => (
                  <li key={s.id}>
                    ...
                    >
                      {`${sections.findIndex(x => x.id === s.id) + 1}. ${s.title}`}
                    </button>
                  </li>
                ))}
              </ul>
            ...
            <div ref={containerRef} className="bg-white border border-gray-200 rounded-3xl shadow-sm p-6 md:p-10 space-y-12">
              ...
              <PPSection id="uppgifter" title="3. Vilka uppgifter samlar vi in?">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Eventuell positionering:</strong> platsdata från stämplings‑ eller leveransappar när uppdrag kräver det (se Säkerhet & DPIA).
                  </li>
                </ul>
              ...
              <PPSection id="profilering" title="6. Profilering och automatiserade beslut">
              ...
              <PPSection id="mottagare" title="7. Mottagare av personuppgifter">
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Personuppgiftsbiträden:</strong> IT‑ och molnleverantörer (lön, schema/tid, testverktyg, e‑signering, e‑post), växeltjänster, säkerhet/ID‑system. Biträden får endast behandla enligt våra instruktioner och avtal.</li>
                ...
                <p className="mt-4"><strong>Gemensamt personuppgiftsansvar</strong> kan uppstå med vissa kunder för specifika processer (t.ex. arbetsmiljö på uppdragsplatsen). I sådana fall dokumenteras ett arrangemang som tydligt fördelar roller och ansvar och essensen görs tillgänglig på begäran.</p>
              </PPSection>

              <PPSection id="overforingar" title="8. Överföring till länder utanför EU/EES">
                <p>Vi strävar efter EU/EES‑behandling. Om överföring till tredjeland sker (t.ex. global molntjänst) använder vi <strong>adekvansbeslut</strong> eller <strong>standardavtalsklausuler (SCC)</strong> och vid behov ytterligare tekniska/organisatoriska skydd. Du kan begära en kopia av tillämpliga skyddsåtgärder via kontaktuppgifterna nedan.</p>
              </PPSection>

              <PPSection id="lagring" title="9. Lagringstider (gallring)">
              ...
              <PPSection id="sakerhet" title="10. Säkerhet">
              ...
              <PPSection id="rattigheter" title="11. Dina rättigheter">
                <ul className="list-disc pl-6 space-y-2">
                ...
                <p className="mt-4">Du kan utöva rättigheterna genom att kontakta oss (se Kontakt). Om du är missnöjd har du rätt att lämna klagomål till Integritetsskyddsmyndigheten (IMY): <a className="text-blue-700 underline" href="https://www.imy.se" target="_blank" rel="noreferrer">www.imy.se</a>.</p>
              </PPSection>

              <PPSection id="cookies" title="12. Cookies och liknande tekniker">
              ...
              <PPSection id="barn" title="13. Barns personuppgifter">
                <p>Våra tjänster riktar sig inte till barn. Vi samlar inte medvetet in barns personuppgifter.</p>
              </PPSection>

              <PPSection id="dpia" title="14. Dataskyddsbedömningar (DPIA)">
                <p>Inför eller vid ändring av behandlingar som kan medföra <strong>hög risk</strong> – t.ex. omfattande spårning/positionering, avancerad profilering eller behandling av känsliga uppgifter – genomför vi konsekvensbedömningar och vidtar riskreducerande åtgärder.</p>
              </PPSection>

              <PPSection id="forandringar" title="15. Förändringar i denna policy">
              ...
              <PPSection id="kontakt" title="16. Kontakt">
              ...
              <PPSection id="bilaga-a" title="17. Bilaga A – Exempel på mottagarkategorier (anpassa)">
                <ul className="list-disc pl-6 space-y-2">
              ...
              <PPSection id="bilaga-b" title="18. Bilaga B – Exempel på gallringsplan (anpassa)">
                <ul className="list-disc pl-6 space-y-2">
              ...
              <div className="rounded-xl border border-blue-200 bg-blue-50 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-[#08132B] mb-1">Ditt förtroende är viktigt för oss</h3>
                    <p className="text-gray-700">Vi arbetar kontinuerligt för att säkerställa att dina personuppgifter behandlas säkert och transparent. Tveka inte att kontakta oss vid frågor.</p>
                  </div>
                </div>
              </div>
