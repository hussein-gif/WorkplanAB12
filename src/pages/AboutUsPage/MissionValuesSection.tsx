...
const Background = React.memo(function Background({ particles }: { particles: Particle[] }) {
  return (
    <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(59,130,246,0.4) 0%, rgba(99,102,241,0.2) 40%, transparent 70%)',
          left: '10%',
          top: '20%',
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(16,185,129,0.35) 0%, rgba(52,211,153,0.15) 50%, transparent 70%)',
          right: '15%',
          bottom: '25%',
          transform: 'translateZ(0)',
          willChange: 'transform',
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(168,85,247,0.3) 0%, rgba(147,51,234,0.1) 60%, transparent 70%)',
          left: '60%',
          top: '10%',
          transform: 'translateZ(0)',
          willChange: 'transform',
      ...
      <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M0,200 Q200,100 400,200 T800,200 L800,300 Q600,400 400,300 T0,300 Z" fill="url(#waveGradient1)" />
        <path d="M0,400 Q300,300 600,400 T1200,400 L1200,500 Q900,600 600,500 T0,500 Z" fill="url(#waveGradient2)" />
      </svg>
      ...
      <div
        ...
        style={{
          background:
            'conic-gradient(from 0deg at 50% 50%, rgba(59,130,246,0.2) 0deg, transparent 60deg, rgba(99,102,241,0.15) 120deg, transparent 180deg, rgba(168,85,247,0.1) 240deg, transparent 300deg, rgba(59,130,246,0.2) 360deg)',
          borderRadius: '50%',
          filter: 'blur(40px)',
        }}
      />
      <div
        ...
        style={{
          background:
            'conic-gradient(from 180deg at 50% 50%, rgba(16,185,129,0.15) 0deg, transparent 90deg, rgba(52,211,153,0.1) 180deg, transparent 270deg, rgba(16,185,129,0.15) 360deg)',
          borderRadius: '50%',
          filter: 'blur(50px)',
        }}
      />

      {/* Floating Particles (STATIC from useMemo) */}
      {particles.map((p) => (
        <div
          key={p.id}
...
const ValueItem = React.memo(function ValueItem({
  Icon,
  title,
  text,
  bgFrom,
  ...
  return (
    <div className="flex items-start space-x-4">
      <div
        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${bgFrom} ${bgTo} flex items-center justify-center flex-shrink-0`}
      >
...
const MissionValuesSection: React.FC = React.memo(function MissionValuesSection() {
  // Skapas en gång; inget reflow-”sprattel”
  ...
  return (
    <section
      ...
      style={{
        ...
        contain: 'layout paint', // säkert, inga externa beroenden
      }}
    >
      {/* Creative Abstract Background (oförändrad visuellt) */}
          ...
          <div>
            ...
            <div className="space-y-6">
              <ValueItem
                Icon={Shield}
                title="Transparens"
                text="Öppna processer, tydlig prissättning och ärlig kommunikation."
                bgFrom="from-blue-500"
                bgTo="to-blue-600"
              />
              <ValueItem
                Icon={Star}
                title="Kvalitet i varje matchning"
                text="Strukturerad screening, referenskontroll och noggranna leveranser."
              ...
              <ValueItem
                ...
                text="En dedikerad kontaktperson och uppföljning hela vägen."
      ...
      {/* Fonts (tips: lägg gärna som <link rel="preconnect/preload"> i <head> i stället för @import för bästa LCP) */}
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          /* ingen aktiv animation här, men lämna plats för framtida effekter */
        }
      `}</style>
    </section>
  );
