 ...
 * - Sätter <html class="force-nav-dark"> så att Header visar mörk logga/länkar även i toppläget
 */

// Lazy load ikoner (minskar initial JS)
...
const CookiePolicyPage: React.FC = () => {
  ...
  // Force mörk navbar på denna sida
  useEffect(() => {
                ...
                <CPSection id="forandringar" title="11. Förändringar i denna policy">
                  ...
                  <div className="mt-6 p-6 bg-[#08132B]/5 border border-[#08132B]/20 rounded-xl">
                    <h4 className="font-semibold text-[#08132B] mb-2 flex items-center gap-2">
                      <Suspense fallback={<span className="inline-block w-5 h-5 bg-gray-200 rounded" />}>
                        <CookieIcon size={20} />
                      </Suspense>
                      Frågor om cookies
                    </h4>
